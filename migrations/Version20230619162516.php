 ...
 */
final class Version20230619162516 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE glossary (id CHAR(36) NOT NULL, discipline_id CHAR(36) DEFAULT NULL, project_id CHAR(36) DEFAULT NULL, en VARCHAR(200) DEFAULT NULL, pt VARCHAR(200) DEFAULT NULL, es VARCHAR(200) DEFAULT NULL, created_on TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_on TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_B0850B43A5522701 ON glossary (discipline_id)');
        $this->addSql('CREATE INDEX IDX_B0850B43166D1F9C ON glossary (project_id)');
        $this->addSql('COMMENT ON COLUMN glossary.created_on IS \'(DC2Type:datetime_immutable)\'');
        $this->addSql('CREATE TABLE project (id CHAR(36) NOT NULL, client_id CHAR(36) DEFAULT NULL, name VARCHAR(70) DEFAULT NULL, hatch_number VARCHAR(7) NOT NULL, client_number VARCHAR(20) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE glossary ADD CONSTRAINT FK_B0850B43166D1F9C FOREIGN KEY (project_id) REFERENCES project (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE glossary DROP CONSTRAINT FK_B0850B43166D1F9C');
